...
class AfterLogoutRedirection implements LogoutSuccessHandlerInterface
{
     ...
     */
    public function __construct(RouterInterface $router, $security)
    {
        $this->router = $router;
    ...
    public function onLogoutSuccess(Request $request)
    {
        ...
        if (in_array('ROLE_ETUDIANT', $rolesTab, true) || in_array('ROLE_ADMIN', $rolesTab, true) || in_array('ROLE_SUPER_ADMIN', $rolesTab, true))
